...
// $issuedbook=$query -> rowCount(); 
    ...
    $sql ="SELECT tblbooks.BookName as BookName,tblcategory.CategoryName,tblauthors.AuthorName,tblbooks.ISBNNumber,tblbooks.id as bookid,tblbooks.bookImage,tblbooks.isIssued,tblbooks.bookQty,  
               COUNT(tblbookhistory.id) AS issuedBooks,
   COUNT(tblbookhistory.RetrunStatus) AS returnedbook

        FROM tblbooks
        LEFT JOIN tblbookhistory ON tblbookhistory.BookId = tblbooks.id
